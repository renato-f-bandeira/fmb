...
print("2. Buscando dados climáticos na API (Modo Rápido)...")
...
for index, row in gdf_pontos.iterrows():
    ...
    # Voltamos para 60 dias para a API responder mais rápido, é suficiente para o cálculo
    ...
    try:
        # Timeout curto de 5 segundos. Falhou? Pula imediatamente.
        ...
        # --- C. EQUAÇÃO LOGÍSTICA (Índice Mata Branca) ---
        ...
        print(f"⚠️ Erro ao buscar dados para {nome_cidade}. Preenchendo sem dados.")
        gdf_pontos.at[index, 'Classe_Risco'] = 'Sem Dados'
        gdf_pontos.at[index, 'Cor_Risco'] = '#bdc3c7'

    # Pausa super rápida só para não bombardear o servidor
    time.sleep(0.2)

print("3. Unindo os resultados matemáticos aos polígonos do mapa...")
# Agora usando o nome correto da sua coluna: 'nome'
...
# Unindo polígonos e pontos pela coluna 'nome'
